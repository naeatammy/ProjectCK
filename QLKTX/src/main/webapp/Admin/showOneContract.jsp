        ...
        <form action="" method="">
            <table>
                <tr>
                    ...
                    <td><input type="text" name="hoten" id="hoten" value="Trần Văn An" required /></td>
                    <td><label for="gioitinh">Giới tính</label></td>
                    <td><input type="text" name="gioitinh" value="Nam" required /></td>
                </tr>
                <tr>
                    <td><label for="ngaysinh">Ngày sinh</label></td>
                    <td><input type="text" name="ngaysinh" value="04/09/2004" required /></td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" name="cccd" value="04825374823940" required /></td>
                </tr>
                <tr>
                    <td><label for="thoigian">Thời gian thuê</label></td>
                    <td><input type="text" name="thoigian" value="3 tháng" required /></td>
                </tr>
                <tr>
                    <td><label for="from">Từ</label></td>
                    <td><input type="text" name="from" value="01/11/2024" required /></td>
                    <td><label for="to">Đến</label></td>
                    <td><input type="text" name="to" value="31/01/2025" required /></td>
                </tr>
                <tr>
                    <td><label for="trangthai">Trạng thái</label></td>
                    <td><input type="text" name="trangthai" value="Đang thuê" required /></td>
                </tr>
                <tr>
